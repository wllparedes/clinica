<nav class="fixed top-0 z-50 w-full bg-cyan-950 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex ms-2 md:me-24">
                    ...
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl text-white whitespace-nowrap dark:text-white">APD
                        Clinica</span>
                </a>
            </div>
